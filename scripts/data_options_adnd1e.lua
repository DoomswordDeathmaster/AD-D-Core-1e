...
function registerOptions()
	...
	OptionsManager.registerOption2("useOsricInitiativeDelay", false, "option_header_adnd1e", "option_label_adnd1e_initiative_delay_allow", "option_entry_cycler", 
		{ labels = "option_val_off", values = "off", baselabel = "option_val_on", baseval = "on", default = "on" });
	...
	OptionsManager.registerOption2("useOsricInitiativeSwap", false, "option_header_adnd1e", "option_label_adnd1e_initiative_osric_swap", "option_entry_cycler", 
