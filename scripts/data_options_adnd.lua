...
function registerOptions()
    ...
    OptionsManager.registerOption2("HouseRule_DeathsDoor", false, "option_header_adnd_options", "option_label_ADND_DEATHSDOOR", "option_entry_cycler", 
      { labels = "option_val_zero|option_val_minus_three", values = "exactlyZero|zeroToMinusThree", baselabel = "option_val_zero_or_less", baseval = "zeroOrLess", default = "zeroOrLess" });
    ...
    { labels = "option_val_hr_crit_maxdmg|option_val_hr_crit_timestwo|option_val_hr_crit_doubledice", values = "max|timestwo|doubledice", baselabel = "option_val_hr_crit_none", baseval = "none", default = "none" });
